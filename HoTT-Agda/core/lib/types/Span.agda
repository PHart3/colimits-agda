...
record SpanMap-Rev {i₀ j₀ k₀ i₁ j₁ k₁} (span₀ : Span {i₀} {j₀} {k₀}) (span₁ : Span {i₁} {j₁} {k₁})
  : Type (lmax (lmax (lmax i₀ j₀) k₀) (lmax (lmax i₁ j₁) k₁)) where
  constructor span-map-rev
  module span₀ = Span span₀
  module span₁ = Span span₁
  field
    hA : span₀.A → span₁.A
    hB : span₀.B → span₁.B
    hC : span₀.C → span₁.C
    f-commutes : CommSquare hC hA span₀.f span₁.f
    g-commutes : CommSquare hC hB span₀.g span₁.g 
