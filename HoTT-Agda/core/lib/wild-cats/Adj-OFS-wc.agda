...
module _ {i₁ i₂ j₁ j₂} {C : WildCat {i₁} {j₁}} {D : WildCat {i₂} {j₂}} {L : Functor-wc C D} {R : Functor-wc D C}
  (adj : Adjunction L R)  (hex : adj-wc-hexagon adj)  -- assumption of hexagon coherence condition
