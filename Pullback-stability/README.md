...
in the coslice category of types (`Stability-cos-coc.agda`). Finally,
give an explicit construction of coslice pullbacks from standard pullbacks
in a type universe (`Cos-pullback.agda`).
...
3. Type check the files `Stability-ord.agda`, `Stability-cos-coc.agda`, and `Cos-pullback.agda`.
